...
def _generate_drop_csv(n_rows: int = CSV_BUFFER_SAMPLES) -> str:
    """
    Generates a realistic mock CSV trace simulating drone movement followed by a drop.
    Includes timestamps, accelerometer (ax, ay, az), and gyroscope/quaternions (qw, qx, qy, qz).
    """
    rows = []
